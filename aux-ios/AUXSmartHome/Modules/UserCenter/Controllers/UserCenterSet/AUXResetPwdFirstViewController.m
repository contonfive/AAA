//
//  AUXResetPwdFirstViewController.m
//  AUXSmartHome
//
...
@interface AUXResetPwdFirstViewController ()<UITextFieldDelegate>
...
@implementation AUXResetPwdFirstViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.passworldTextField.delegate = self;
    self.passworldTextField.returnKeyType = UIReturnKeyNext;
...
- (IBAction)nextButtonAction:(UIButton *)sender {
    ...
    if (self.passworldTextField.text.length < 8) {
        ...
        AUXResetPwdInpuNewPwdViewController *resetPwdInpuNewPwdViewController = [AUXResetPwdInpuNewPwdViewController instantiateFromStoryboard:kAUXStoryboardNameUserCenter];
        resetPwdInpuNewPwdViewController.oldPwd = self.passworldTextField.text;
        [self.navigationController pushViewController:resetPwdInpuNewPwdViewController animated:YES];
    }
}
