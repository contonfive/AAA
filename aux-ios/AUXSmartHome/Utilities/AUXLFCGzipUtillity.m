...
@implementation AUXLFCGzipUtillity
...
+ (NSData *)gzipData:(NSData *)pUncompressedData
{
    ...
    NSLog(@"%s: Compressed file from %lu B to %lu B", __func__, (unsigned long)[pUncompressedData length], (unsigned long)[compressedData length]);
